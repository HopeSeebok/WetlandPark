...
public class reader {
	...
	/**
	 * @author Administrator_007 锟斤拷锟斤拷UHF模锟介： 2015.09
	 */
						...
						if (substr[i].length() >= 10) {
							if (substr[i].substring(0, 10).equals("000100677E")) {
								...
								if (Error.length() >= 16) {
									...
									if (sigin.equals("12")) {
										msg.obj = "该标签没有在场区或者指定的 EPC 代码不对";
									}
									if (sigin.equals("D0")) {
										msg.obj = "没有 Kill Password密码";
									}
								}
								m_handler.sendMessage(msg);
							}
			...
			public void run() {
				...
				while (m_handler != null) {
					...
					if (nTemp == 0) {
						...
						if (m_nread > 10)
							break;
						// BC110525666888999123888C 5DC90B7E BB0112000100147E
						// BB01FF0001B3B47E
						// }
						// BB01FF010100E3400123456789123456789787878C77E
						// BB0139000C12121212122121321212121
						// BB 01 49 0010 0E(PC+EPC锟斤拷锟斤拷)
						// 3400777756789123456789787878 00(锟斤拷志00锟斤拷锟缴癸拷) A97E
						...
						if (str.startsWith("BB0149")) {
							...
							// String readdata = str.substring(12 + pcepclen *
							// 2,
							// str.length() - 4);
			...
			public void run() {
				...
				while (m_handler != null) {
					...
					if (nTemp == 0) {
						...
						if (m_nread > 5)
							break;
						// BB01FF0010 100E 34007777567891234567897878786F7E 写锟斤拷
						// BB 02 22 0011D3 3400777756789123456789787878 BE
						// C9D07E
						// BB01FF0010B30E 3400777756789123456789787878127E7E
						// BB0139 001B 0E
						// 3400777756789123456789787878锟斤拷PC+EPC锟斤拷
						// 123456789123456789787878锟斤拷锟斤拷锟斤拷锟斤拷 097E(校锟斤拷位)
						// }
						// BB0139 000C 3FA734001234567891234567D47E
						String str = reader.BytesToString(m_buf, 0, m_nCount);
						Log.e("1111111", str);
						// BB0139 000C 121212121212131313131313 24 7E
						// BB0139 000C 121212121212131313131313 24 7E
						// BB0139 000C BC110525666888999123888C F4 7E
						// BB0139 000C BC110525666888999123888C F4 7E
						if (str.startsWith("BB0139")) {
							...
							msg.obj = readdata;// str.substring(10, str.length()
												// - 4);
	...
	// System.out.println(encode("锟斤拷锟斤拷"));
	// System.out.println(decode(encode("锟斤拷锟斤拷")));

	/*
	 * 16锟斤拷锟斤拷锟斤拷锟斤拷锟街凤拷锟斤拷
	 */
	private static String hexString = "0123456789ABCDEF";

	/*
	 * 锟斤拷锟街凤拷锟斤拷锟斤拷锟斤拷锟�16锟斤拷锟斤拷锟斤拷锟斤拷,锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟街凤拷锟斤拷锟斤拷锟斤拷锟斤拷锟侥ｏ拷
	 */
	public static String encode(String str) {
		// 锟斤拷锟斤拷默锟较憋拷锟斤拷锟饺★拷纸锟斤拷锟斤拷锟�
		byte[] bytes = str.getBytes();
		StringBuilder sb = new StringBuilder(bytes.length * 2);
		// 锟斤拷锟街斤拷锟斤拷锟斤拷锟斤拷每锟斤拷锟街节诧拷锟斤拷2位16锟斤拷锟斤拷锟斤拷锟斤拷
	...
	/*
	 * 锟斤拷16锟斤拷锟斤拷锟斤拷锟街斤拷锟斤拷锟斤拷址锟斤拷锟�,锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟街凤拷锟斤拷锟斤拷锟斤拷锟斤拷锟侥ｏ拷
	 */
	...
	/**
	 * 寻锟斤拷锟斤拷锟斤拷锟斤拷锟睫改碉拷EPC锟角凤拷晒锟斤拷锟�
	 * 
	 * @param strwepc
	 *            锟斤拷锟睫改碉拷EPC
