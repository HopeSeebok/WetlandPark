...
public class SwitchMultiButton extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mStrokeRadius = typedArray.getDimension(R.styleable.SwitchMultiButton_switchRadius, dp2px(STROKE_RADIUS));
        mStrokeWidth = typedArray.getDimension(R.styleable.SwitchMultiButton_switchWidth, dp2px(STROKE_WIDTH));
        mTextSize = typedArray.getDimension(R.styleable.SwitchMultiButton_switchTextSize, sp2px(TEXT_SIZE));
        mSelectedColor = typedArray.getColor(R.styleable.SwitchMultiButton_switchSelectedColor, SELECTED_COLOR);
        mSelectedTab = typedArray.getInteger(R.styleable.SwitchMultiButton_switchSelectedTab, SELECTED_TAB);
        typedArray.recycle();
    }
