...
public class MineFragment extends BaseFragment {
    ...
    private void initUI() {
        if (ZNAPPlication.getUserInfoEntity(getActivity()) != null) {
            ...
            unitTv.setText(ZNAPPlication.getUserInfoEntity(getActivity()).getDep());
        }
    }
    ...
    private void exitDialog() {
        DialogFactory.showMsgDialog(getActivity(), "提示", "确定要退出" + IUtils.getStrToRes(getActivity(), R.string.app_name) + "?", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IActivityManage.getInstance().exit();
            }
