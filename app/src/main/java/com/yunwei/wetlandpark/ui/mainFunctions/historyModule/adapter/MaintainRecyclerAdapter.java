 ...
 */
public class MaintainRecyclerAdapter extends BaseRecyclerViewAdapter<TroubleShooterTable> {


    private Context mContext;
    private TroubleShooterTable mTable;

    public MaintainRecyclerAdapter(Context context) {
        mContext = context;
    }
    ...
    public void onBindBaseViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        holders.itemWorkHistoryLayoutFirstTitleTextView.setText("");
        holders.itemWorkHistoryLayoutSecondTitleTextView.setText("维护时间:" + IDateTimeUtils.formatDate(mTable.getTime()));
        holders.itemWorkHistoryLayoutThirdTitleTextView.setText("");
