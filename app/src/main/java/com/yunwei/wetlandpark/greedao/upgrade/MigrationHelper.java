...
/**
 * author: zls <347035812@qq.com>
 * version: V1.0
 * created at 2017/4/5 10:16
 * <p>
...
public class MigrationHelper {
    ...
    private void generateTempTables(SQLiteDatabase db, Class<? extends AbstractDao<?, ?>>... daoClasses) {
        for (int i = 0; i < daoClasses.length; i++) {
            ...
            String beforeCreateTableString = String.valueOf(createTableStringBuilder);
            ...
            //上个版本没有此表
            if (beforeCreateTableString.equals(createTableStringBuilder.toString())) {
                return;
            }
