...
import com.yunwei.wetlandpark.greedao.upgrade.MigrationHelper;
...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static class DevOpenHelper extends OpenHelper {
        public DevOpenHelper(Context context, String name, CursorFactory factory) {
            ...
            Log.e("GreenDao", "DevOpenHelper Constructor");
        }

        @Override
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.e("GreenDao", "Upgrading schema from version " + oldVersion + " to " + newVersion + " by dropping all tables" +"CBOK TAG");
//            dropAllTables(db, true);
//            onCreate(db);
            MigrationHelper.getInstance().migrate(db,
                    SignInTableDao.class);
